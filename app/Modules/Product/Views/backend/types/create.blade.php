    ...
    <div class="card">
        <div class="card-header">
            <div class="row col-sm">
                <h5><i class="fa fa-plus-square"></i> Add Product Type</h5>
            </div>
        </div>
        {!! Form::open(['route'=>'admin.product.types.store', 'method'=>'post','enctype'=>'multipart/form-data','id'=>'dataForm']) !!}
        <div class="card-body">
            <div class="row">
        ...
        <div class="card-footer">
            <a href="{{ route('admin.product.types.index') }}" class="btn btn-warning"><i class="fa fa-backward"></i> Back</a>
