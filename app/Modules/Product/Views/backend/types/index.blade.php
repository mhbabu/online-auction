...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-5">
                    <h5><i class="fa fa-list-alt"></i> Product Types</h5>
                </div><!--col-->

                <div class="col-sm-7 pull-right">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                        <a href="{{ route('admin.product.types.create') }}" class="btn btn-sm btn-success" title="Create new" data-original-title="Create New">
...
@section('footer-script')
    ...
    <script type="text/javascript">
        $(document.body).on('click', '.action-delete', function (ev) {
            ...
            let redirectURL = "{{ route('admin.product.types.index') }}";
