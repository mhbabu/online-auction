...
use App\DataTables\Backend\User\UserDataTable;
...
class UserController extends Controller
{
    ...
    {
        return $dataTable->render("User::backend.index");
    }
    ...
    public function create()
    {
        $data['userTypes'] = UserType::where('is_registrable',1)
            ...
            ->where('is_archive',0)
            ->pluck('type_name','id');
        return view('User::backend.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.users.index'))->with('flash_message','Your account created successfully');
    }
    ...
    public function edit($userId)
    {
        ...
        return view("User::backend.edit",$data);
    }
